...
- Colors and typography — only tokens from `src/index.css :root`; don't introduce new colors, reuse components from `src/os/os.css` classes first. Canon — the brand book: `docs/full-vision/09_Design_System/Visual_Reference.md`, Part II (D2 tokens, D5 catalog, D6 state semantics, D9 overlays, D10 usage rules).
