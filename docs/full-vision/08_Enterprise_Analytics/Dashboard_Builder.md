...
> Уточнение (2026-07-13): Workspace этого документа — реализация рабочего пространства сущности (`05_Architecture/Workspace_Platform.md`); дашборд — одна из возможностей пространства, не самостоятельная концепция.
