...
- [../adr/README.md](../adr/README.md) — Architecture Decision Records: журнал реализационных решений (шаблон — `../adr/0000-template.md`).
...
- [Management_Model.md](02_Product/Management_Model.md) — **канон модели управления** (приоритет после PRD): два типа карт, роли, мягко-жёсткая увязка, офисные агенты, навык ≠ компетенция.
